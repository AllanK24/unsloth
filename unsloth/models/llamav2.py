...
class FastLlamaModelV2:
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        # Model patcher modified to FastLlamaModelV2
        # if model_patcher is None: model_patcher = FastLlamaModel
        if model_patcher is None: model_patcher = FastLlamaModelV2
        ...
        if num_labels is not None:
        ...
        elif not fast_inference: ### MAYBE WE NEED TO MODIFY THIS IF vLLM isn't used???
            ...
            ### DISABLE LORA if max_lora_rank is None
            if max_lora_rank is None:
                del load_vllm_kwargs["enable_lora"]; del load_vllm_kwargs["max_lora_rank"]
        ...
        model.for_inference = functools.partial(FastLlamaModelV2.for_inference, model)
        m = model
        while hasattr(m, "model"):
...
PatchFastRL(FastLanguageModel = FastLlamaModelV2)
